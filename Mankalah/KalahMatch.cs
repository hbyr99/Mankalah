...
namespace Mankalah
{
    ...
    public class KalahMatch {
        ...
        private static Player pTop = new Copycat(Position.Bottom, timeLimit);	// TOP player (MAX)
        private static Player pBot = new hb43Player(Position.Top, timeLimit);	// BOTTOM player	
